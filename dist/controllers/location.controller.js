...
const getLocations = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const [data, totalItems] = yield Promise.all([
            ...
            db_1.default.location.count({ where })
        ]);
        const result = {
            data,
            pagination: {
...
const createLocation = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const result = yield db_1.default.location.create({ data: { name } });
...
const updateLocation = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        // Check
        const existing = yield db_1.default.location.findFirst({
            where: {
                name: {
                    equals: name,
                    mode: "insensitive"
        ...
        const result = yield db_1.default.location.update({
            where: { id },
            data: { name }
        });
