...
router.post('/add', upload.single('image'), (0, asyncHandler_1.asyncHandler)(member_controller_1.createMember));
router.put('/:id', upload.single('image'), auth_middleware_1.authenticateToken, (0, asyncHandler_1.asyncHandler)(member_controller_1.updateMember));
