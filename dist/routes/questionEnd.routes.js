...
router.get("/all", (0, asyncHandler_1.asyncHandler)(questionEnd_controller_1.getQuestionsEnd));
...
// User
router.post('/end', (0, asyncHandler_1.asyncHandler)(questionEnd_controller_1.EndQuestionUpdateStatus));
