...
import { certificateEnd, certificatePDF, certificatePDFSend, checkIdCard, createMember, deleteMember, getMembers, memberUpdateDateOfTraining, updateMember, updateVerify } from '../controllers/member.controller';
